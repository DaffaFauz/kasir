      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-group form-inline">
            <label for="" class="form-control-label pr-2">Bulan dan Tahun:</label>
...
<script>
  function getData() {
    ...
    if (tgl == '') {
      ...
      $.ajax({
        type: 'post',
        url: '<?= base_url('laporan/bulanan/data') ?>',
        data: {
          tgl: tgl
        },
        dataType: 'JSON',
  ...
  function printLaporan() {
    ...
    if (tgl == '') {
      ...
      newWin = window.open('/laporan/bulanan/' + tgl, 'newWin', 'toolbar=no, width=1000, height=500')
    }
  }
</script>
<?= $this->endSection() ?>