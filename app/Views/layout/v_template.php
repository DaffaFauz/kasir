                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li class="<?= ($active == 'barang') ? 'active' : '' ?>"><i class="fa fa-puzzle-piece"></i><a href="/produk">Barang</a></li>
                            ...
                            <li class="<?= ($active == 'user') ? 'active' : '' ?>"><i class="fa fa-puzzle-piece"></i><a href="/user">User</a></li>
                        </ul>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li class="<?= ($active == 'harian') ? 'active' : '' ?>"><i class="fa fa-puzzle-piece"></i><a href="tables-data.html">Harian</a></li>
                            <li class="<?= ($active == 'bulanan') ? 'active' : '' ?>"><i class="fa fa-puzzle-piece"></i><a href="tables-data.html">Bulanan</a></li>
                            <li class="<?= ($active == 'tahunan') ? 'active' : '' ?>"><i class="fa fa-puzzle-piece"></i><a href="tables-data.html">Tahunan</a></li>
                        </ul>
                    </li>
                    </li>
